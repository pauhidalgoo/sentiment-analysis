...
The data used was the [Movie Reviews Corpus](https://www.cs.cornell.edu/people/pabo/movie-review-data/), downloaded via nltk, consisting of 1000 positive and 1000 negative movie reviews (we have split in 25% test, 18.75% val and 56.25% train).

The supervised models use the library [scikit-learn](https://scikit-learn.org/stable/).
...
**UKB** is a SOTA word sense disambiguator, described in [this paper](http://dx.doi.org/10.3115/1609067.1609070), [this other](https://arxiv.org/abs/1805.04277)... by the IXA group of the University of the Basque Country (you can find more information [here](https://ixa2.si.ehu.eus/ukb/)).
